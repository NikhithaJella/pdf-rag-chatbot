...
const appCss = "/assets/styles-CA64oh__.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "PDF RAG Assistant with Hybrid Retrieval" },
...
const $$splitComponentImporter = () => import("./index-B4hqXN9s.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "PDF RAG Assistant with Hybrid Retrieval"
    }]
  }),
